...
def main():
    ...
    while True:
        ...
        if choice == "1":
            player_choice = int(input("Select player (1-13): "))
            ...
            player_choice = int(input("Select player to delete (1-13): "))
            if 1 <= player_choice <= len(players):
                del_player = players.pop(player_choice - 1)
                print(f"{del_player.name} deleted successfully!")
            else:
                print("Invalid player selection. Try again.")
